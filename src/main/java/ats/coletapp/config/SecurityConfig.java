        ...
        public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
                ...
                return http
                                ...
                                .authorizeHttpRequests((auth) -> auth
                                                ...
                                                .requestMatchers("/users/cadUser", "/users/recoveryPassword","/users/verificationCode", "/users/updatePassword").permitAll()
                                                .requestMatchers("/home","/pin", "/forgot_password").permitAll()
